...
var TracePanel = function (_Component) {
  ...
  function TracePanel(props, context) {
    _classCallCheck(this, TracePanel);

    var _this = _possibleConstructorReturn(this, (TracePanel.__proto__ || Object.getPrototypeOf(TracePanel)).call(this, props));

    _this.data = context.data;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          children.map(function (c) {
            return (0, _react.cloneElement)(c, { index: i });
          })
        )
      );
    }
...
//# sourceMappingURL=trace-panel.js.map