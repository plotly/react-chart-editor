    ...
    _createClass(ArrowSelector, [{
        ...
        value: function arrowGenerator() {
            ...
            var allArrows = arrowArray.map(function (each) {
                return _react2.default.createElement(
                    'svg',
                    { width: '40', height: '20', 'data-arrowhead': '1', style: { position: 'relative', top: '5px' } },
                    _react2.default.createElement('line', { stroke: 'rgb(68, 68, 68)', style: { fill: 'none' }, x1: '5', y1: '10', x2: '23.8', y2: '10', strokeWidth: '2' }),
                    _react2.default.createElement('path', { d: each.path, transform: 'translate(23.8,10)rotate(360)scale(2)', style: { fill: 'rgb(68, 68, 68)', opacity: 1, strokeWidth: 0 } })
                );
            });
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Dropdown2.default, { ref: 'dropdown',
