...
var ConfirmBox = function ConfirmBox(props) {
  ...
  var confirmBtnClassName = (0, _classnames2.default)(baseConfirmBtnClassName, {
  ...
  if (dangerouslySetMessageInnerHtml) {
    ...
    msg = _react2.default.createElement("p", { className: "confirmbox__message", dangerouslySetInnerHTML: innerHTML });
  } else {
