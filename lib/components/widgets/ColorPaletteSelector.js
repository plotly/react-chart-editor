    ...
    _createClass(ColorPaletteSelector, [{
        ...
        value: function addColorScale(newColorScale) {
            ...
            if (!newColorScale || newColorScale.length === 0) {
                ...
                var Plotly = _environment2.default.plotly;
        ...
        value: function _renderColorScale(newColorscale, key) {
            ...
            for (var i = 0; i < colorscaleLength; i++) {
                ...
                colorblocks[i] = _react2.default.createElement('div', { key: i,
...
ColorPaletteSelector.propTypes = {
     ...
     */
    userDataIndex: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.number, _react2.default.PropTypes.array]).isRequired,
    isGrouped: _react2.default.PropTypes.bool,
    isPie: _react2.default.PropTypes.bool.isRequired
};
