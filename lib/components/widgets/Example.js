...
var LoadExampleButton = exports.LoadExampleButton = function (_Component) {
  ...
  _createClass(LoadExampleButton, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(ExampleButton, {
...
LoadExampleButton.propTypes = {
  chartType: _propTypes2.default.oneOf(Object.keys((0, _graphTable.GET_ENCODING_SCHEMA)())),
...
var ExampleButton = function ExampleButton(props) {
  ...
  if (props.status === STATUS.ERROR) {
    return _react2.default.createElement(
      "div",
      { className: buttonClass, onClick: props.loadExample },
...
ExampleButton.propTypes = {
  loadExample: _propTypes2.default.func.isRequired,
  status: _propTypes2.default.oneOf(Object.keys(STATUS))
};
