  ...
  _createClass(SimpleAddMenu, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: className, onClick: addNewMenuHandler },
        "+ " + buttonText
      );
    }
  }]);
...
SimpleAddMenu.propTypes = {
  addNewMenuClass: _propTypes2.default.string,
  addNewMenuHandler: _propTypes2.default.func,
  disableAddMenu: _propTypes2.default.bool,
  addMenuText: _propTypes2.default.string
};
...
var DropdownAddMenu = exports.DropdownAddMenu = function (_Component2) {
  ...
  _createClass(DropdownAddMenu, [{
    ...
    value: function render() {
      ...
      var simpleAddMenuPlaceholder = _react2.default.createElement(SimpleAddMenu, { addMenuText: title });
...
DropdownAddMenu.propTypes = {
  addNewMenuConfig: _propTypes2.default.shape({
    title: _propTypes2.default.string.isRequired,
    options: _propTypes2.default.arrayOf(_customPropTypes.dropdownOptionShape).isRequired
  }),
  addNewMenuClass: _propTypes2.default.string,
  addNewMenuHandler: _propTypes2.default.func
};
...
AccordionMenu.propTypes = {
  ...
  /*
     ...
     */
  assignOpenState: _propTypes2.default.bool,
