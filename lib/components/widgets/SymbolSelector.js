...
var _color = require("@workspace/utils/color");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var SymbolSelector = _react2.default.createClass({
  displayName: "SymbolSelector",

  propTypes: {
    activeOption: _react2.default.PropTypes.string,
    toggleMenu: _react2.default.PropTypes.func.isRequired,
    changeSymbol: _react2.default.PropTypes.func.isRequired,
    symbolColor: _react2.default.PropTypes.string,
  ...
  changeSymbol: function changeSymbol(newSymbol) {
    this.props.changeSymbol(newSymbol);
  },
  renderSymbolList: function renderSymbolList() {
    var symbolOptions = [{
      value: "circle",
      alias: 0,
      ...
      fill: "none"
    }, { value: "hourglass", alias: 25, label: "M5,5H-5L5,-5H-5Z" }, { value: "bowtie", alias: 26, label: "M5,5V-5L-5,5V-5Z", gl: true }, {
      ...
      fill: "none",
      gl: true
    }, { value: "line-ne-open", alias: 43, label: "M5,-5L-5,5", fill: "none" }, { value: "line-nw-open", alias: 44, label: "M5,5L-5,-5", fill: "none" }];

    if (this.props.is3D) {
      symbolOptions = symbolOptions.filter(function (option) {
        return option.threeD;
      });
    }

    if (this.props.traceType === "scattergl") {
      symbolOptions = symbolOptions.filter(function (option) {
        return option.gl;
      });
    }
  ...
  renderActiveOption: function renderActiveOption() {
    var _props = this.props,
        symbolColor = _props.symbolColor,
        borderColor = _props.borderColor;

    var currentlyActive = this.props.activeOption;
    var allSymbols = this.renderSymbolList();

    var currentSymbol = allSymbols.find(function (symbol) {
      return symbol.value === currentlyActive;
    });
    ...
    var symbolStyle = {
      stroke: currentSymbol.fill === "none" ? symbolColor : borderColor,
      strokeOpacity: "1",
      strokeWidth: "2px",
      fill: currentSymbol.fill === "none" ? "none" : symbolColor
    };
  ...
  renderOptions: function renderOptions() {
    ...
    var _props2 = this.props,
        symbolColor = _props2.symbolColor,
        borderColor = _props2.borderColor;

    var allOptions = this.renderSymbolList();
    ...
    return allOptions.map(function (option) {
      ...
      var symbolStyle = {
        stroke: fill === "none" ? symbolColor : borderColor,
        strokeOpacity: "1",
        strokeWidth: "2px",
        fill: fill === "none" ? "none" : symbolColor
      };
      return _react2.default.createElement(
        "div",
        {
          ...
          ref: value,
          key: value,
          onClick: _this.changeSymbol.bind(_this, value)
        },
        _react2.default.createElement(
          "svg",
          {
  ...
  render: function render() {
    ...
    var subMenuDisplay = (0, _classnames2.default)(["symbol-selector__menu"], {
      "+visible": isOpen,
      "+hidden": !isOpen
    });

    var backgroundColor = (0, _color.isTooLight)(this.props.symbolColor) ? "#bec8d9" : "white";
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "span",
          { ref: "title", className: "symbol-selector__toggle_option" },
          this.renderActiveOption()
        ),
        _react2.default.createElement(
          "span",
          { className: "symbol-selector__toggle__caret" },
          _react2.default.createElement("i", { className: "icon-caret-down" })
        )
      ),
      _react2.default.createElement(
        "div",
        { className: subMenuDisplay, style: backgroundStyle },
        this.renderOptions()
      )
    );
  }
