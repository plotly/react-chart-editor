...
var Slider = function (_Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function positionToValue(position) {
      ...
      var sliderSize = (0, _reactDom.findDOMNode)(this.refs.sliderBox)[dimension];
    ...
    value: function getPosition(event) {
      var sliderBox = (0, _reactDom.findDOMNode)(this.refs.sliderBox);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: sliderBox, ref: "sliderBox", onMouseDown: this.moveSlider },
        this.renderFill(),
...
Slider.propTypes = {
  value: _react2.default.PropTypes.oneOfType([_propTypes2.default.number, _propTypes2.default.string]),
