...
var _UncontrolledTextarea = require("./UncontrolledTextarea");
...
MapboxStyleUrlController.propTypes = {
  ...
  updatePlot: _propTypes2.default.object.isRequired,
  ...
  function renderOptions() {
    ...
    if (valueType === VALUE_TYPES.PRESET) {
      ...
      return _react2.default.createElement(
        ...
        menuItem(_react2.default.createElement(
          "div",
          { className: buttonClass, onClick: onSubmit },
          _buttonText
        )),
        errorMessage,
        viewJsonButton,
...
MapboxStyleUrl.propTypes = {
  valueType: _propTypes2.default.oneOf(Object.keys(VALUE_TYPES)).isRequired,
  values: _propTypes2.default.shape((_PropTypes$shape = {}, _defineProperty(_PropTypes$shape, VALUE_TYPES.PRESET, _propTypes2.default.oneOf(["basic", "outdoors", "light", "dark", "satellite", "satellite-streets"])), _defineProperty(_PropTypes$shape, VALUE_TYPES.MAPBOX_STUDIO, _propTypes2.default.string), _defineProperty(_PropTypes$shape, VALUE_TYPES.MAPBOX_ATLAS, _propTypes2.default.object), _defineProperty(_PropTypes$shape, VALUE_TYPES.JSON, _propTypes2.default.object), _PropTypes$shape)).isRequired,
  status: _propTypes2.default.oneOf(Object.keys(STATUS)).isRequired,
  error: _propTypes2.default.object,
  atlasStyleURL: _propTypes2.default.string,

  changeValueType: _propTypes2.default.func,
  setValue: _propTypes2.default.func,
  updatePlot: _propTypes2.default.func,
  setAtlasURL: _propTypes2.default.func,
  downloadAtlasJSON: _propTypes2.default.func,
  viewJson: _propTypes2.default.func,
