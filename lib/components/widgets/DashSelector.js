...
var DashSelector = _react2.default.createClass({
    ...
    propTypes: {
        activeOption: customPropTypes.customOneOfType([_react2.default.PropTypes.oneOf(['solid', 'dot', 'dash', 'longdash', 'dashdot', 'longdashdot']), customPropTypes.isNull]).isDefined,
