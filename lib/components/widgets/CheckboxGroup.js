      ...
      return this.state.options.map(function (option, i) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            option.checked && _react2.default.createElement(
              'div',
              { className: checkClass },
              _react2.default.createElement(_plotlyIcons.CheckIcon, null)
            )
          ),
          _react2.default.createElement(
            'div',
            { className: 'checkbox__label', onClick: function onClick() {
                return _this2.handleChange(i);
              } },
            option.label
          )
