  ...
  _createClass(AccordionMenuItem, [{
    ...
    value: function render() {
      ...
      if (isRemovable && typeof removeMenuHandler === "function") {
        closeIcon = _react2.default.createElement("i", { className: closeClass, onClick: this.handleRemoveMenu });
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { ref: "toggle", className: subMenuOpen, onClick: onToggle },
          _react2.default.createElement(
            "span",
            ...
            iconClass ? _react2.default.createElement(
              "div",
              { className: topIcon },
              _react2.default.createElement("i", { className: iconClass, style: titleStyling })
            ) : null,
            _react2.default.createElement(
              "div",
              { ref: "title", className: titleClass },
              title
            )
          ),
          closeIcon
