...
UnconnectedSelectColumn.propTypes = {
    ...
    onColumnSelection: _react.PropTypes.func.isRequired,
    selectedColumnId: _react.PropTypes.oneOfType([_customPropTypes.stringOrNull, _react.PropTypes.array]),
    placeholder: _react.PropTypes.string,
    minWidth: _react.PropTypes.string,
    multi: _react.PropTypes.bool,
    multiTable: _react.PropTypes.bool,
