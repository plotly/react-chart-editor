...
Hint.propTypes = {
    ...
    delayMilliseconds: _react.PropTypes.number,
    position: _react.PropTypes.oneOf(['bottom-right', 'bottom', 'bottom-left', 'right', 'left', 'top-right', 'left', 'top-right', 'top', 'top-left']),
