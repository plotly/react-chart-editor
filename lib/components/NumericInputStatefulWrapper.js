...
function mapPropsToState(_ref) {
    ...
    var value = void 0;
    var mixedMode = propValue === _workspace.MIXED_VALUES;
    ...
    if (mixedMode) {
         ...
         */
        value = _workspace.MIXED_MODE_VALUE;
...
var NumericInputStatefulWrapper = function (_Component) {
    ...
    _createClass(NumericInputStatefulWrapper, [{
        ...
        value: function onUpdate(value) {
             ...
             */
            if (this.state.mixedMode && updatedValue === _workspace.MIXED_MODE_VALUE) {
                 ...
                 */
                this.setState({ value: _workspace.MIXED_MODE_VALUE });
                return;
            }
            ...
            if ((0, _fastIsnumeric2.default)(updatedValue)) {
                ...
                if (numericBounds) {
                    updatedValue = (0, _number.keepWithinMaxMin)(updatedValue, min, max);
...
NumericInputStatefulWrapper.propTypes = {
     ...
     */
    integerOnly: _react.PropTypes.bool,
    ...
    value: customPropTypes.customOneOfType([_react.PropTypes.string, customPropTypes.isNumeric, customPropTypes.isNull]).isDefined
};
