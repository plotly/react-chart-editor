...
var SingleSidebarItem = function (_Component) {
  _inherits(SingleSidebarItem, _Component);

  function SingleSidebarItem() {
    _classCallCheck(this, SingleSidebarItem);

    return _possibleConstructorReturn(this, (SingleSidebarItem.__proto__ || Object.getPrototypeOf(SingleSidebarItem)).apply(this, arguments));
  }
