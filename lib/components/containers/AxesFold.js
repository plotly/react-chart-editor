...
var AxesFold = function (_Component) {
  ...
  _createClass(AxesFold, [{
    ...
    value: function render() {
      ...
      return options.length && children ? _react2.default.createElement(
        _PlotlyFold2.default,
        this.props,
        options.length === 1 ? null : _react2.default.createElement(_AxesSelector2.default, { axesOptions: options }),
        children
      ) : null;
    }
  }]);
