...
function connectNonCartesianSubplotToLayout(WrappedComponent) {
  var SubplotConnectedComponent = function (_Component) {
    ...
    _createClass(SubplotConnectedComponent, [{
      ...
      value: function getChildContext() {
        ...
        return {
          getValObject: function getValObject(attr) {
            return !_this2.context.getValObject ? null : _this2.context.getValObject(_this2.props.subplot + '.' + attr);
          },
      ...
      value: function provideValue() {
        ...
        return {
          getValObject: function getValObject(attr) {
            return !_this3.context.getValObject ? null : _this3.context.getValObject(_this3.props.subplot + '.' + attr);
          },
          updateContainer: this.updateSubplot,
          container: this.container,
          fullContainer: this.fullContainer
  ...
  SubplotConnectedComponent.propTypes = {
    subplot: _propTypes2.default.string.isRequired
  };
